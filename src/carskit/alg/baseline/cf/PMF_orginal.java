...
/**
 * PMF_orginal: Mnih, Andriy, and Ruslan Salakhutdinov. "Probabilistic matrix factorization." Advances in neural information processing systems. 2007.
 * <p></p>
...
public class PMF_orginal extends IterativeRecommender {

    public PMF_orginal(SparseMatrix rm, SparseMatrix tm, int fold) {
