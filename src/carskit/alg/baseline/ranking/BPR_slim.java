...
/**
 * BPR_slim: Rendle, Steffen, et al. "BPR_slim: Bayesian personalized ranking from implicit feedback." Proceedings of the Twenty-Fifth Conference on Uncertainty in Artificial Intelligence. AUAI Press, 2009.
 <p></p>
...
public class BPR_slim extends SLIM {

    public BPR_slim(SparseMatrix trainMatrix, SparseMatrix testMatrix, int fold) {
