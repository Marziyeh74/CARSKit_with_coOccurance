...
/**
 * BPR_orginal: Rendle, Steffen, et al. "BPR_orginal: Bayesian personalized ranking from implicit feedback." Proceedings of the Twenty-Fifth Conference on Uncertainty in Artificial Intelligence. AUAI Press, 2009.
 <p></p>
...
public class BPR_orginal extends IterativeRecommender {

    public BPR_orginal(SparseMatrix trainMatrix, SparseMatrix testMatrix, int fold) {
