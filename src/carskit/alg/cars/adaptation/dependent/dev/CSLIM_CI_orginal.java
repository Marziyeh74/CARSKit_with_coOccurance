...
/**
 * CSLIM_CI_orginal: Zheng, Yong, Bamshad Mobasher, and Robin Burke. "CSLIM: Contextual slim recommendation algorithms." Proceedings of the 8th ACM Conference on Recommender Systems. ACM, 2014.
 * <p></p>
...
public class CSLIM_CI_orginal extends CSLIM {
    ...
    public CSLIM_CI_orginal(SparseMatrix trainMatrix, SparseMatrix testMatrix, int fold) {
