...
public class GCSLIM_MCS extends CSLIM {
    ...
    public GCSLIM_MCS(SparseMatrix trainMatrix, SparseMatrix testMatrix, int fold) {
        ...
        System.out.println("CSLIM_MCS constructor");
        isRankingPred = true;
    ...
    protected void initModel() throws Exception {
        super.initModel();
         ...
         System.out.println("CSLIM_MCS initModel");
        ...
        if (knn > 0) {
         ...
         System.out.println("- end CSLIM_MCS initModel");
    }
    ...
    protected void buildModel() throws Exception {
         ...
         System.out.println("CSLIM_MCS buildModel");
    ...
    protected boolean isConverged(int iter) {
         ...
         System.out.println("CSLIM_MCS isConverged");
